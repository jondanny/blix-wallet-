...
resource "aws_autoscaling_group" "admin_ecs_asg" {
  ...
  tag {
    ...
    value               = "Admin Dev Cluster Instance"
  }
}

resource "aws_ecs_task_definition" "admin" {
  family                = "admin_dev_ecs_task_definition"
  container_definitions = jsonencode([
    {
      ...
      logConfiguration: {
        ...
        options: {
          ...
          awslogs-stream-prefix: "admin_dev"
        }
      }
    }
  ])
