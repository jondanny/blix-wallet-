...
import { TicketCreateReplyMessage } from '@src/consumer/messages/ticket-create-reply.message';
...
import { TicketDeleteReplyMessage } from '@src/consumer/messages/ticket-delete-reply.message';
import { TicketTransferEventPattern, TicketTransferStatus } from '@src/ticket-transfer/ticket-transfer.types';
import { TicketTransferFactory } from '@src/database/factories/ticket-transfer.factory';
import { TicketTransferReplyMessage } from '@src/consumer/messages/ticket-transfer-reply.message';
...
import { UserCreateReplyMessage } from '@src/consumer/messages/user-create-reply.message';
